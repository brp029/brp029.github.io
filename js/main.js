...
function createVis(data) {
  ...
  eventHandler.bind("selectionChanged", function (event) {
    ...
    totalsVis.onSelectionChange(rangeStart, rangeEnd);
    genderVis.onSelectionChange(rangeStart, rangeEnd);
    ageVis.onSelectionChange(rangeStart, rangeEnd);
    eduVis.onSelectionChange(rangeStart, rangeEnd);
    raceVis.onSelectionChange(rangeStart, rangeEnd);
  });
